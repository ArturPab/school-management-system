...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .and()
                .authorizeRequests().antMatchers("/api/student/**").hasAnyRole("ADMIN", "STUDENT", "TEACHER")
                .and()
                .authorizeRequests().antMatchers("/api/student/create").hasRole("ADMIN")
                .and()
                .authorizeRequests().antMatchers("/api/teacher/**").hasAnyRole("ADMIN", "TEACHER")
                .and()
                .authorizeRequests().antMatchers("/api/teacher/create").hasRole("ADMIN")
                .and()
                .authorizeRequests().antMatchers("/api/mark/**").hasAnyRole("ADMIN", "TEACHER")
                .and()
